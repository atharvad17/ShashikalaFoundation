      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our team consists of professional artists, educators, and arts administrators who are dedicated to providing high-quality art experiences. We are supported by a passionate board of directors and a network of volunteers who share our commitment to making art accessible to all.
            </p>
